...
#define CMD18 0x12 ////write relay5
#define CMD19 0x13 ////write relay6
#define CMD20 0x14 ////write relay7
#define CMD21 0x15 ////write relay8
  ...
  if (ET.receiveData())
  {
    ...
    if (mydata.id == ID )
    {
      ...
      if (mydata.command == CMD14)
      {
        ...
        {
          old_version = old_version & 0xbf;
        }
#endif
        ET.sendData();
      }
      if (mydata.command == CMD15)
      {
        digitalWrite(A3, !mydata.data0);
