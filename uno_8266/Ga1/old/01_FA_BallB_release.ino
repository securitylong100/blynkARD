...
//String Folder_name = "LDP_5SG";
String fileName = "FA_BallB_L01_";
String SerialName = "\"FA-BallB";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"FA_BallB\"";

byte SizeOfInspectItemName = 4;
String InspectItemName1 = ",\"LS_BENT\",";
String InspectItemName2 = ",\"LS_HARD\",";
String InspectItemName3 = ",\"LS_NG\",";
String InspectItemName4 = ",\"BB_NG\",";
