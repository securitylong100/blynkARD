...
//String Folder_name = "LDP_5SG";
String fileName = "FA_APP_L01_";
String SerialName = "\"FA-APP";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"FA_APP\"";

byte SizeOfInspectItemName = 5;
String InspectItemName1 = ",\"PA_OPEN\",";
String InspectItemName2 = ",\"SOLDER\",";
String InspectItemName3 = ",\"WELD_NG\",";
String InspectItemName4 = ",\"PA_OPP\",";
String InspectItemName5 = ",\"PA_NG\",";
