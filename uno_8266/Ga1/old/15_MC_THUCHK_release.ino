...
//String Folder_name = "LDP_5SG";
String fileName = "MC_THUCHK_L01_";
String SerialName = "\"MC-THUCHK";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"MC_THUCHK\"";

byte SizeOfInspectItemName = 5;
String InspectItemName1 = ",\"THU_UPNG\",";
String InspectItemName2 = ",\"THU_DWNG\",";
String InspectItemName3 = ",\"THU_NG\",";
