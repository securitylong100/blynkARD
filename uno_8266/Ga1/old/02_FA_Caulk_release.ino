...
//String Folder_name = "LDP_5SG";
String fileName = "FA_Caulk_L01_";
String SerialName = "\"FA-Caulk";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"FA_Caulk\"";

byte SizeOfInspectItemName = 5;
String InspectItemName1 = ",\"FR_BENT\",";
String InspectItemName2 = ",\"NUT_NG\",";
String InspectItemName3 = ",\"GUI_NG\",";
String InspectItemName4 = ",\"SHA_HIGH\",";
String InspectItemName5 = ",\"FR_BENT\",";
