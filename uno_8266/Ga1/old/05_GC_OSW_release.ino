...
//String Folder_name = "LDP_5SG";
String fileName = "GC_OSW_L01_";
String SerialName = "\"GC-OSW";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"GC_OSW\"";

byte SizeOfInspectItemName = 5;
String InspectItemName1 = ",\"OP_NG\",";
String InspectItemName2 = ",\"WAS_BAV\",";
String InspectItemName3 = ",\"CUT_WAS\",";
String InspectItemName4 = ",\"MT_DEFOR\",";
String InspectItemName5 = ",\"GC_BAVA\",";
