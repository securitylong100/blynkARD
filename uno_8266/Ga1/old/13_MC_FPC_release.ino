...
//String Folder_name = "LDP_5SG";
String fileName = "MC_FPC_L01_";
String SerialName = "\"MC-FPC";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"MC_FPC\"";

byte SizeOfInspectItemName = 5;
String InspectItemName1 = ",\"FPC_NG\",";
String InspectItemName2 = ",\"PIN_NG\",";
String InspectItemName3 = ",\"FPC_BEND\",";
