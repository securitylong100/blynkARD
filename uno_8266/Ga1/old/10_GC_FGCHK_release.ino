...
//String Folder_name = "LDP_5SG";
String fileName = "GC_FGCHK_L01_";
String SerialName = "\"GC-FGCHK";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"GC_FGCHK\"";

byte SizeOfInspectItemName = 5;
String InspectItemName1 = ",\"PION_NG\",";
String InspectItemName2 = ",\"FG_NG\",";
String InspectItemName3 = ",\"DIRTY\",";
