...
//String Folder_name = "LDP_5SG";
String fileName = "MC_APPCHK_L01_";
String SerialName = "\"MC-APPCHK";
String LotNoName = ",\"Motor\"";
String ModelName = ",\"LDP_5SG\"";
String SiteName = ",\"NCVP\"";
String FactoryName = ",\"2A\",\"";
String LineName = "L01";
String ProcessName = "\",\"MC_APPCHK\"";

byte SizeOfInspectItemName = 12;
String InspectItemName1 = ",\"DUST\",";
String InspectItemName2 = ",\"WELD_NG\",";
String InspectItemName3 = ",\"WELD_MCH\",";
String InspectItemName4 = ",\"RUN_NG\",";
String InspectItemName5 = ",\"STM_NG\",";
String InspectItemName6 = ",\"FPC_BEND\",";
String InspectItemName7 = ",\"SHA_HIGH\",";
String InspectItemName8 = ",\"PA_OPEN\",";
String InspectItemName9 = ",\"PIN_NG\",";
String InspectItemName10 = ",\"FR_BENT\",";
String InspectItemName11 = ",\"CA_OPP\",";
String InspectItemName12 = ",\"FR_NUT\",";
...
#define CMD3 0x04  // can't send ftp.nnnnnnnnnn
...
void initWifi()
{
  ...
  //them vao
  IPAddress staticIP(192, 168, 148, 253);
  IPAddress gateway(192, 168, 144, 254);
  IPAddress subnet(255, 255, 240, 0);
  byte mac_def[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED};
  WiFi.macAddress(mac_def);
  WiFi.begin(ssid, password); //da co san
...
void getdata()
{
  ...
  data3 += dataCommon0 + InspectItemName3 + dataCommon1 + String(LineData.countOfNG3) + dataCommon2;
  data4 += dataCommon0 + InspectItemName4 + dataCommon1 + String(LineData.countOfNG4) + dataCommon2;
  data5 += dataCommon0 + InspectItemName5 + dataCommon1 + String(LineData.countOfNG5) + dataCommon2;
  data6 += dataCommon0 + InspectItemName6 + dataCommon1 + String(LineData.countOfNG6) + dataCommon2;
  data7 += dataCommon0 + InspectItemName7 + dataCommon1 + String(LineData.countOfNG7) + dataCommon2;
  data8 += dataCommon0 + InspectItemName8 + dataCommon1 + String(LineData.countOfNG8) + dataCommon2;
  data9 += dataCommon0 + InspectItemName9 + dataCommon1 + String(LineData.countOfNG9) + dataCommon2;
  data10 += dataCommon0 + InspectItemName10 + dataCommon1 + String(LineData.countOfNG10) + dataCommon2;
  data11 += dataCommon0 + InspectItemName11 + dataCommon1 + String(LineData.countOfNG11) + dataCommon2;
  data12 += dataCommon0 + InspectItemName12 + dataCommon1 + String(LineData.countOfNG12) + dataCommon2;
}
void RTC_process()
{
...
void write_backup_data()
{
  ...
  if (myFile)
  {
    ...
    myFile.println(data4);
    myFile.println(data5);
    myFile.println(data6);
    myFile.println(data7);
    myFile.println(data8);
    myFile.println(data9);
    myFile.println(data10);
    myFile.println(data11);
    myFile.println(data12);
    // close the file:
    myFile.close();
#ifdef DEBUG
    Serial.println("done.");
